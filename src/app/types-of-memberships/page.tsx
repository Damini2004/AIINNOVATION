    ...
    <div className="bg-background text-foreground">
      ...
      >
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="text-sm mt-2">
            ...
            <span className="text-primary font-medium">TYPES OF MEMBERSHIPS</span>
          </div>
        </div>
      </section>
      ...
      <main className="py-24">
        <div className="container mx-auto px-6 text-center">
            ...
            <p className="mt-4 text-muted-foreground">This page is under construction. Check back later for details about the types of memberships we offer.</p>
        </div>
      </main>
    </div>
  );
