...
export default function HostEventContent() {
  const processSteps = [
    {
            ...
            <div className="relative group">
               <iframe width="100%" height="500px" src="https://www.youtube.com/embed/UYGbTqu4JDY?si=_LJ08zTbOr80lXzv&autoplay=1&mute=0" allow="autoplay" allowFullScreen></iframe>
                <a
                  ...
                  className="pulse-btn absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center w-20 h-20 rounded-full bg-primary text-primary-foreground hover:bg-primary/90 transition"
                >
