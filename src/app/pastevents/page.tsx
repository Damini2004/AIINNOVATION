...
export default function PastEventsPage() {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        setLoading(true);
        // Using getEvents for now, can be replaced with getPastEvents if created
      ...
      <main className="blog_area py-24">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h5 className="text-primary font-semibold">Past Events</h5>
            <h2 className="text-3xl font-bold">
              Memories of our growth <span className="text-primary">portfolio</span>
            </h2>
